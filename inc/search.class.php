...
class Search {
   ...
   static function showProjectSearch(){
	GLOBAL $DB,$CFG_GLPI;
	...
	$opt6['addicon']= false;        
        ...
        $importeMaximo = 0;
        $sql = "select max(importe_proyecto) as importeMaximo from glpi_projects";
        $result1 = $DB->query($sql);
        if ($DB->numrows($result1)>0){
            while ($data1 = $DB->fetch_array($result1)) {
                $importeMaximo = $data1['importeMaximo'];
            }
        }
        $duracionMaxima = 120;
        /**
        $sql = "select max(timestampdiff(month, plan_start_date, plan_end_date)) as duracionMaxima from glpi_projects";
        $result2 = $DB->query($sql);
        if ($DB->numrows($result2)>0){
            while ($data2 = $DB->fetch_array($result2)) {
                $duracionMaxima = $data2['duracionMaxima'];
            }        
        }**/
	echo "<div style='position:relative; width:100%; margin: 0px auto 8px auto;'>";
	echo "<div class='cuadro_busqueda'>";
		...
		echo "<table style='width: 100%; margin: 4px 10px;'>";
		echo "<tr>";
                        echo "<td rowspan='9' style='text-align: center;vertical-align: top;padding: 30px 4px 20px 1px;'><img id='imgProyectos' src='../pics/proyectos.png' style='height:8em;'/></td>";
			echo "<td style='width:10%; padding: 4px; text-align: right;'>";
			echo "Denominación ";
			echo "</td>";
			echo "<td style='width:40%; padding: 4px;'>";
			echo "<input id='denominacion' type='text' />";
			echo "</td>";		
			echo "<td style='width:10%; padding: 4px; text-align: right;'>";
		...
		echo "<tr>";
			...
			echo "</td>";
			echo "<td style='width:40%; padding: 4px;'>";
			echo "<div id='id_provincia' style='width: 203px; display:inline-block; position:relative;'><span class='no-wrap'><div class='select2-container'><a class='select2-choice' style='width:190px;'><span class='select2-chosen'>-----------------------------</span></a></div></span></div>";
			echo "</td>";
		echo "</tr>";
		echo "<tr>";
			echo "<td style='width:10%; padding: 4px; text-align: right;'>";
			...
			echo "</td>";
			echo "<td style='width:40%; padding: 4px;'>";
			ProjectState::dropdown($opt4);
			echo "</td>";		
			echo "<td style='width:10%; padding: 4px; text-align: right;'>";
			echo "Cliente";
			echo "</td>";
			echo "<td style='width:40%; padding: 4px;'>";				
			ProjectCliente::dropdown($opt4);
			echo "</td>";	
		echo "</tr>";
		echo "<tr style='padding:4px;'>";
			echo "<td style='width:10%; padding: 4px; text-align: right;'>";
			echo "En ejecución durante el año";
			echo "</td>";
			echo "<td style='width:40%; padding: 4px;'>";
			echo "<input type='text' id='anio' value='' style='width:80px;'/>";
			echo "</td>";
			echo "<td style='width:10%; padding: 4px; text-align: right;'>";
			echo "Sector";
			echo "</td>";
			echo "<td style='width:40%; padding: 4px;'>";			
			PluginComproveedoresExperiencestype::dropdown($opt5);
			echo "</td>";			
		echo "</tr>";
                echo "<tr style='padding:4px;'>";
			echo "<td style='width:10%; padding: 4px; text-align: right;'>";
			echo "Código";
			echo "</td>";
			echo "<td colspan='3' style='width:40%; padding: 4px;'>";
			echo "<input type='text' id='codigo' value='' style='width:80px;'/>";
			echo "</td>";                        
                echo "</tr>";
		echo "<tr>";
		echo "</tr>";
		...
		echo "<tr>";
			echo "<td colspan='1'>";
			echo "<input type='submit' name='search' value='' title='Mis proyectos' class='boton_misproyectos' style='margin: 15px 45%; position:relative;' />";
			echo "</td>";                 
			echo "<td colspan='1'>";
			echo "<input type='submit' name='search' value='' title='GRÁFICAS' class='boton_chart' style='margin: 15px 45%; position:relative;' />";
			echo "</td>";       
                        echo "<td colspan='1'>";                        
			...
			echo "</td>";       
                        echo "<td colspan='1'>";
			echo "<input type='submit' name='search' value='' title='BUSCAR' class='boton_buscar' style='margin: 15px 45%; position:relative;' />";
			echo "</td>";
		echo "</tr>";
		echo "</table>";
	echo "</div>";
	...
	echo "<div id='resultadoBusqueda' style='width: 100%;border: 1px solid #ccc;min-height: 50px; background-color: #e6e6e6;'></div>";
        
        echo "<div id='modalGraficas' title='Gráficas'>";
                echo "<table style='width: 100%; margin: 4px 10px;'>";
                echo "<tr>";   
                    echo "<td>Elija el tipo de gráfica</td>";
                    echo "<td><select id='grafica' style='border-radius: 4px; height: 30px; font-size: 14px; width: 300px; background-color: #e5e5e5; font-weight: bold;'>";
                        echo "<option value='1'>Nº de proyectos por tipología</option>";
                        echo "<option value='2'>Nº de proyectos por cliente</option>";
                    echo "</select></td>";
                echo "</tr>";      
                echo "<tr>";   
                    echo "<td id='titulo' colspan='2'>";
                    echo "</td>";
                echo "</tr>";                 
                echo "<tr>";   
                    echo "<td id='contenido' colspan='2'>";
                    echo "</td>";
                echo "</tr>";  
                echo "</table>";              
        echo "</div>";        
	...
	echo "<script type='text/javascript' >
                ...
                function limpiar(){
                    $('#denominacion').val('');
                    $('#codigo').val('');
                    $('[id^=\'dropdown_plugin_comproveedores_servicetypes_id\']').val(0); 
                    $('[id^=\'dropdown_plugin_comproveedores_servicetypes_id\']').change();
                    $('[id^=\'dropdown_plugin_comproveedores_communities_id\']').val(0);  
                    $('[id^=\'dropdown_plugin_comproveedores_communities_id\']').change();
                    $('[id^=\'dropdown_plugin_comproveedores_provinces_id\']').val(0);  
                    $('[id^=\'dropdown_plugin_comproveedores_provinces_id\']').change();
                    $('[id^=\'dropdown_projectstates_id\']').val(0); 
                    $('[id^=\'dropdown_projectstates_id\']').change();
                    $('input[name=projectclientes_id]').val(0); 
                    $('input[name=projectclientes_id]').change(); 
                    $('#duracionminima').val(0); 
                    $('#duracionmaxima').val(120); 
                    $('#minima').val(0); 
                    $('#maxima').val(currency($importeMaximo)); 
                    $('#anio').val('');
                    $('[id^=\'dropdown_plugin_comproveedores_experiencestypes_id\']').val(0); 
                    $('[id^=\'dropdown_plugin_comproveedores_experiencestypes_id\']').change();
                }
                ...
                $('.boton_misproyectos').on('click', function() {
                    misProyectos();
                });
                
                $('.boton_chart').on('click', function() {
                    $('#modalGraficas').dialog('open');
                });
		...
		$(function() {
			...
			$('[id*=dropdown_criteria_1__field_').attr('disabled','true');
                ...
                function misProyectos() {              
                    ...
                    var serviceType = $('[id^=\'dropdown_plugin_comproveedores_servicetypes_id\']').val();                    
                    var region = $('[id^=\'dropdown_plugin_comproveedores_communities_id\']').val();  
                    var provincia = $('[id^=\'dropdown_plugin_comproveedores_provinces_id\']').val();  
                    var estado = $('[id^=\'dropdown_projectstates_id\']').val(); 
                    var cliente = $('input[name=projectclientes_id]').val(); 
                    var duracionMinima = $('#duracionminima').val(); 
                    var duracionMaxima = $('#duracionmaxima').val(); 
                    var costeMinimo = $('#minima').val().replace(' €','').replace('.','').replace('.','').replace('.','').replace('.',''); 
                    var costeMaximo = $('#maxima').val().replace(' €','').replace('.','').replace('.','').replace('.','').replace('.',''); 
                    var anio = $('#anio').val();
                    var codigo = $('#codigo').val();
                    var experiencestypesid = $('[id^=\'dropdown_plugin_comproveedores_experiencestypes_id\']').val(); 

                    var parametros = {'denominacion': denominacion,
                                    ...
                                    'costeMinimo': costeMinimo,
                                    'costeMaximo': costeMaximo,
                                    'anio': anio,
                                    'codigo': codigo,
                                    'experiencestypesid': experiencestypesid};
                                    
                    $.ajax({  
                        type: 'GET',        		
                        url: '".$CFG_GLPI["root_doc"]."/plugins/comproveedores/inc/listProjectMP.php',
                        data: parametros,
                        success:function(data){
                ...
                function buscar() {
                    ...
                    $.ajax({  
                        type: 'GET',        		
                        url: '".$CFG_GLPI["root_doc"]."/plugins/comproveedores/inc/listProject.php',
                        data: parametros,
                        success:function(data){
                            $('#resultadoBusqueda').html(data);
                        },
		...
		function currency(value, decimals, separators) {
			var decimals = decimals >= 0 ? parseInt(decimals, 0) : 0;
		...
		$('#slider-duracion').slider({
		  range: true,
		  min: 0,
		  max: 120,
		  values: [ 0, 120],
		  slide: function( event, ui ) {
			$('#duracionminima' ).val( ui.values[ 0 ]);
			$('#duracionmaxima' ).val( ui.values[ 1 ]);
		  }
		});   
                
                $('#maxima').on('blur', function(){
                    var valor =  $('#maxima').val();
                    $('#maxima').val(currency(valor));
                });
                
		$('#duracionminima').val('0');
		$('#duracionmaxima').val('120');		
		$('#minima').val('0');
                var formatImporteMaximo = currency($importeMaximo);
         ...
         switch ($table.'.'.$field) {
            ...
            case "glpi_tickets.internal_time_to_resolve" :
               ...
               if (($ID == 151) || ($ID == 158)
                  ...
                  $out .= "<div class='center' style='background-color: #ffffff; width: 100%; border: 1px solid #9BA563; position: relative;' >";
                  $out .= "<div style='position:absolute;'>&nbsp;".$percentage_text."%</div>";
                  $out .= "<div class='center' style='background-color: ".$color."; wdth: ".$percentage."%; height: 12px' ></div>";
                  $out .= "</div>";
                  return $out;
               }
               break;
