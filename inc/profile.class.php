...
class Profile extends CommonDBTM {
   ...
   static public $helpdesk_rights = ['create_ticket_on_login','create_cv_on_login', 'followup',
   ...
   **/
   ...
   function showForm($ID, $options = []) {
      ...
      echo "</td></tr>\n";
       echo "<tr class='tab_bg_1'><td>".__('CV creation from login')."</td><td>";
      Html::showCheckbox(['name'    => 'create_cv_on_login',
                               'checked' => $this->fields['create_cv_on_login']]);
      echo "</td></tr>\n";
   ...
   **/
   ...
   function getSearchOptionsNew() {
      ...
      $tab[] = [
         'id'                 => '201',
         'table'              => $this->getTable(),
         'field'              => 'create_cv_on_login',
         'name'               => __('CV creation form on login'),
         'datatype'           => 'bool'
      ];
