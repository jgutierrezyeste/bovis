 ...
 ******************************************/
	...
	if(isset($_POST['add'])){
		...
		Html::back();
                ...
                //$subvaloraciones=[];
                $arrayValoraciones      = $_GET['arrayValoraciones'];
               ...
               $query ="select subvaloracion.*, criterios.criterio_padre, criterios.ponderacion 
                ...
                while ($data = $DB->fetch_array($result)) {
                    ...
                    //Ya no hay comentarios a la subvaloración: $subvaloracion['comentario'] = $subvaloraciones_comentario[$data['criterio_id']];
                    //Sumamos el valor de los subcriterio YA NO HARÍA FALTA SI PASAMOS ESTOS VALORES EN EL $_GET['arrayValoraciones']
                ...
                while ($data = $DB->fetch_array($result2)) {
                    $valoracion[$data['criterio_padre']] = round($arrayValoraciones[$data['criterio_padre']], 2);
                }
                ...
                $valoracion['costes']                                       = $_GET['costes'];
                $valoracion['calidad']                                      = $_GET['calidad'];
                $valoracion['planificacion']                                = $_GET['planificacion'];
                $valoracion['cultura_empresarial']                          = $_GET['cultura_empresarial'];
                $valoracion['gestion_de_suministros_y_subcontratistas']     = $_GET['gestion_de_suministros_y_subcontratistas'];
                $valoracion['seguridad_y_salud_y_medioambiente']            = $_GET['seguridad_y_salud_y_medioambiente'];
                $valoracion['bim']                                          = $_GET['bim'];
                $valoracion['certificacion_medioambiental']                 = $_GET['certificacion_medioambiental'];
                $valoracion['proyecto_basico']                              = $_GET['proyecto_basico'];
                $valoracion['proyecto_de_ejecucion']                        = $_GET['proyecto_de_ejecucion'];
                $valoracion['capacidad_de_la_empresa']                      = $_GET['capacidad_de_la_empresa'];
                $valoracion['colaboradores']                                = $_GET['colaboradores'];
                $valoracion['capacidad']                                    = $_GET['capacidad'];
                $valoracion['actitud']                                      = $_GET['actitud'];
                ...
                $PluginValuation->update($valoracion);
                       ...
                       // $subvaloraciones_comentario=$_GET['arraySubValoracionComentario'];
                        ...
                        //ESTO YA NO HARÍA FALTA PORQUE VIENE INICIALIZADO EN $_GET[arrayValoraciones']
                        //while ($data=$DB->fetch_array($result)) {
                        ...
                        while ($data=$DB->fetch_array($result2)) {
                            ...
                            //Ya no tenemos que hacer las sumas de las subvaloraciones ya que las tenemos sumadas en $_GET['arrayValoraciones']
